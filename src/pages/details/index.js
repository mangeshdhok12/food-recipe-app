...
const Details = () => {
  ...
  return (
    <div className='container mx-auto py-10 grid-cols-1 lg:grid-cols-2 gap-10'>
      ...
      <div>
        <button 
        onClick={()=>handleAddToFavorite(recipeDetailsData?.recipe)} className='p-3 px-8 rounded-lg text-sm uppercase font-medium tracking-wider mt-3 inline-block shadow-md bg-black text-white'>{
